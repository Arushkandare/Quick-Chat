...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full w-full flex flex-col backdrop-blur-lg min-h-0'>
      ...
      <div className='flex items-center gap-3 p-3 flex-shrink-0 border-t border-stone-500/20'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          <input onChange={(e) => setInput(e.target.value)}
            onKeyDown={(e) => e.key === "Enter" ? handleSendMessage(e) : null}
          type="text" placeholder='Send a message' value={input} className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-400 bg-transparent'/>
